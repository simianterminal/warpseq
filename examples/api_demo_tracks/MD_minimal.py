...
# setup clips
api.clips.add(name='setup', scene='scene_0', track='setup', patterns=['vars'], repeat=None, rate=0.25)
api.clips.add(name='s0a', scene='scene_0', track='lead', patterns=['L0'], transforms=[], repeat=None, auto_scene_advance=True)
