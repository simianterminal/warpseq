...
api.instruments.add('fx_inst', device=DEVICE, channel=4, min_octave=0, base_octave=5, max_octave=10, muted=False)
...
# setup transforms
api.transforms.add(name='A1', slots=['1','O+1','O-1'], divide=1)
...
api.transforms.add(name='A5', slots=['1','S+1','S+2','S+3'], divide=4)
api.transforms.add(name='A6a', slots=['ch=power','1'], divide=1)
api.transforms.add(name='A6b', slots=['1','ch=power'], divide=1)
api.transforms.add(name='A7', slots=['1','1','1','O-0,0,1,2','S+0,1,2,3' ], divide=1)
api.transforms.add(name='A8', slots=['1','S+1,2,3,4','1','1','1','1','O-0,0,1,2','S+0,1,2,3' ], divide=1)
